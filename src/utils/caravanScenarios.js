...
export const caravanScenarios = [
    {
        ...
        optionALabel: "Pay Bribe (Costs 300 Gold)",
        optionBLabel: "Outrun Them (Risk Cargo)",
        optionAEffect: { goldChange: -300, integrityChange: 0, text: "You reluctantly slide a purse of 300 Gold to the bandit chief. He smiles and lets your caravan pass without a scratch." },
    ...
    },
    {
        ...
        optionALabel: "Pay for Shelter (Costs 150 Gold)",
        optionBLabel: "Braving the Storm (Risk Cargo)",
        optionAEffect: { goldChange: -150, integrityChange: 0, text: "You pay local nomads 150 Gold for heavy tents and camel shelter. You wait out the storm safely with zero damage." },
    ...
    },
    {
        ...
        optionALabel: "Pay Legal Fee (Costs 250 Gold)",
        optionBLabel: "Slide a Bribe (Costs 100 Gold)",
        optionAEffect: { goldChange: -250, integrityChange: 0, text: "You pay the official 250 Gold tariff. The inspector stamps your ledger with a sigh, and you proceed legally." },
        optionBEffect: { goldChange: -100, integrityChange: -15, text: "You slide him 100 Gold under your travel permit. He pockets it, but forces his guards to search your cart to keep up appearances, damaging fragile packaging (-15% Cargo Integrity)." }
    },
    {
        id: "broken_wheel",
        ...
        optionALabel: "Buy Wood (Costs 150 Gold)",
        optionBLabel: "Abandon Cart (Risk Cargo)",
        optionAEffect: { goldChange: -150, integrityChange: 0, text: "You purchase spare timber for 150 Gold. Your crew repairs the axle in under an hour, saving your entire inventory." },
    ...
    },
    {
        ...
        optionAEffect: { goldChange: 500, integrityChange: -25, text: "The gorge is brutal on the camels, but you arrive ahead of schedule and sell fresh water at an extreme premium (+500 Gold, but -25% Cargo Integrity from the rocky path)." },
    ...
    },
    {
        ...
        optionALabel: "Buy Antivenom (Costs 200 Gold)",
        optionBLabel: "Use Clay Poultice (Free)",
        optionAEffect: { goldChange: -200, integrityChange: 0, text: "You purchase the rare antivenom for 200 Gold. Within hours, your navigator is back on their feet and keeping the caravan perfectly on track." },
    ...
    },
    {
        ...
        optionALabel: "Tow Them (Costs 100 Gold Supplies)",
        optionBLabel: "Ignore Them (No Cost)",
        optionAEffect: { goldChange: 400, integrityChange: 0, text: "You share your rations and hitch their cart to your camels. Upon reaching the market, you sell their gifted saffron for a massive profit (+400 Net Gold gain)." },
